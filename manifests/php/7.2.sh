PHP_IV_SERIES="7.2"
PHP_IV_VERSION="7.2.34"
PHP_IV_SOURCE_ARCHIVE="php-7.2.34.tar.xz"
PHP_IV_SOURCE_URL="https://www.php.net/distributions/php-7.2.34.tar.xz"
PHP_IV_SOURCE_SHA256=""
PHP_IV_SOURCE_DIR="php-7.2.34"
