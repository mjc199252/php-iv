PHP_IV_SERIES="8.2"
PHP_IV_VERSION="8.2.30"
PHP_IV_SOURCE_ARCHIVE="php-8.2.30.tar.xz"
PHP_IV_SOURCE_URL="https://www.php.net/distributions/php-8.2.30.tar.xz"
PHP_IV_SOURCE_SHA256=""
PHP_IV_SOURCE_DIR="php-8.2.30"
...
PHP_IV_NOTES="Current-phase install target."
