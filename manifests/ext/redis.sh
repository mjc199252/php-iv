php_iv_ext_manifest_load() {
  ...
  PHP_IV_EXT_REASON="redis is not supported for this PHP version in the current manifest."
  ...
  if php_iv_version_in_range "$php_version" "7.4.0" "8.4.99"; then
    ...
    PHP_IV_EXT_REASON=""
  elif php_iv_version_in_range "$php_version" "7.0.0" "7.3.99"; then
    PHP_IV_EXT_PACKAGE_VERSION="5.3.7"
    PHP_IV_EXT_SOURCE_ARCHIVE="redis-5.3.7.tgz"
    PHP_IV_EXT_SOURCE_URL="https://pecl.php.net/get/redis-5.3.7.tgz"
    PHP_IV_EXT_SOURCE_DIR="redis-5.3.7"
    PHP_IV_EXT_SUPPORTED="1"
    PHP_IV_EXT_REASON=""
  elif php_iv_version_in_range "$php_version" "5.5.0" "5.6.99"; then
    PHP_IV_EXT_PACKAGE_VERSION="4.3.0"
    PHP_IV_EXT_SOURCE_ARCHIVE="redis-4.3.0.tgz"
    PHP_IV_EXT_SOURCE_URL="https://pecl.php.net/get/redis-4.3.0.tgz"
    PHP_IV_EXT_SOURCE_DIR="redis-4.3.0"
    PHP_IV_EXT_SUPPORTED="1"
    PHP_IV_EXT_REASON=""
  fi
}
