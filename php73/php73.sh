...
cp $phpinstallpathconf/php/7.3/php-fpm.d/www.conf.default $phpinstallpathconf/php/7.3/php-fpm.d/www.conf
...
chmod -R 755 $phpinstallpathconf/php/7.3/php-fpm.d/www.conf

cd ../

rm -rf "php-7.3.12.tar.gz" "php-src-php-7.3.12"

if [[ $systemname =~ 'Darwin' ]]; then
    sed -i '' "23,24c\\
	;user=nobofy\\
	;group=nobody\\" $phpinstallpathconf/php/7.3/php-fpm.d/www.conf
else
